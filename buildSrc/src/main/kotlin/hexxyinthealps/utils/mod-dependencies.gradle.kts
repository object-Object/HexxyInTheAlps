...
abstract class HexxyInTheAlpsModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexxyInTheAlpsModDependenciesExtension>("hexxyinthealpsModDependencies")
